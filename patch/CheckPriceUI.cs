...
namespace WankulCrazyPlugin.patch
{
    public class CheckPriceUI
    {
        ...
        // Tableau d'enum mis en cache une seule fois (au lieu de Enum.GetValues √† chaque appel).
        ...
        {
            // Champs r√©solus via un cache (Plugin.GetPProperty) au lieu d'un AccessTools.Field
            // recalcul√© √† chaque appel de cette m√©thode.
            ...
            for (int j = 0; j < __instance.m_MaxCardUICountPerPage; j++)
            {
                ...
                // Assurez-vous que l'index est valide avant d'insÈrer
                ...
                {
                    // Ajoutez des ÈlÈments null jusqu'‡ ce que l'index soit valide
